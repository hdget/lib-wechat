...
// JsSdkSignature signature接口返回结果
...
// nolint:recheck
func (impl *wxoaImpl) GetJsSdkSignature(url string) (*JsSdkSignature, error) {
...
// 生成微信签名
func (impl *wxoaImpl) generateJsSdkSignature(ticket, url string) (*JsSdkSignature, error) {
	now := time.Now().Unix()
