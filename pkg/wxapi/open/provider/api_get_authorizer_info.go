...
func (impl serviceProviderWxApiImpl) GetAuthorizerInfo(componentAccessToken, authorizerAppid string) (*GetAuthorizerInfoResult, error) {
	...
	ret, err := wxapi.Post[GetAuthorizerInfoResult](url, req)
	if err != nil {
