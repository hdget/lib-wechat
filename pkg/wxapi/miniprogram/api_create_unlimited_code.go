...
func (impl miniProgramWxApiImpl) CreateUnLimitedWxaCode(accessToken string, scene, page string, width int) ([]byte, error) {
	// 获取post的内容
	...
	data, err := wxapi.PostResponse(url, req)
	if err != nil {
