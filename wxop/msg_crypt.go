...
const (
	wxBizMsgCryptOk                   = iota
	errWXBizMsgCryptValidateSignature = -40001
	errWXBizMsgCryptParseXml          = -40002
	errWXBizMsgCryptComputeSignature  = -40003
	ErrWXBizMsgCryptIllegalAesKey     = -40004
	errWXBizMsgCryptValidateAppid     = -40005
	errWXBizMsgCryptEncryptAES        = -40006
	errWXBizMsgCryptDecryptAES        = -40007
	errWXBizMsgCryptIllegalBuffer     = -40008
	ErrWXBizMsgCryptEncodeBase64      = -40009
	ErrWXBizMsgCryptDecodeBase64      = -40010
	ErrWXBizMsgCryptGenReturnXml      = -40011
)
...
func getEncryptContent(postData string) (string, error) {
	...
	var data XmlData
	err := xml.Unmarshal(convert.StringToBytes(postData), &data)
	if err != nil {
		return "", err
	}
